...
direction = input('You\'re at a cross road. Where do you want to go?\nType "left" or "right":').lower()#u can use single quote if u want double quote on line and \ is an escape seq it escapes the next thing behind it and lower() lower every input
if direction == "left":
